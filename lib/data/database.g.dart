    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `walls` (`title` TEXT NOT NULL, `description` TEXT, `location` TEXT, `fileName` TEXT, `filePath` TEXT, `thumbnailName` TEXT, `thumbnailPath` TEXT, `isCustom` INTEGER NOT NULL, `id` INTEGER PRIMARY KEY AUTOINCREMENT, `modified_at` INTEGER, `created_at` INTEGER NOT NULL)');
        await database.execute(
  ...
  Stream<List<Wall>> watchAllWalls() {
    return _queryAdapter.queryListStream('SELECT * FROM walls',
        ...
        mapper: (Map<String, Object?> row) => Wall(
            ...
            thumbnailName: row['thumbnailName'] as String?,
