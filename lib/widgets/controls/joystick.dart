    ...
    return Container(
      ...
      child: Material(
        shape: RoundedRectangleBorder(
            ...
            side: BorderSide(width: 2.0, color: widget.colorControlStick)),
          ...
          child: Stack(
            children: [
              GestureDetector(
                ...
                child: Stack(
                  children: [
                    Align(alignment: Alignment.topCenter, child: Icon(Icons.keyboard_arrow_up, color: widget.colorIcon)),
                    Align(alignment: Alignment.bottomCenter, child: Icon(Icons.keyboard_arrow_down, color: widget.colorIcon)),
                    Align(alignment: Alignment.centerLeft, child: Icon(Icons.keyboard_arrow_left, color: widget.colorIcon)),
                    Align(alignment: Alignment.centerRight, child: Icon(Icons.keyboard_arrow_right, color: widget.colorIcon)),
                  ],
                ),
              ),
              Positioned(
